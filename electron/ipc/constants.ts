...
export const PROJECT_FILE_EXTENSION = "morec";
...
export const ALLOW_MOREC_WINDOW_CAPTURE = Boolean(process.env["VITE_DEV_SERVER_URL"]);
export const RECORDING_SESSION_MANIFEST_SUFFIX = ".morec-session.json";
