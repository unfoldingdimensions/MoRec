...
export function getNativeCaptureHelperBinaryPath(): string {
	return path.join(app.getPath("userData"), "native-tools", "morec-screencapturekit-helper");
}
...
export function getSystemCursorHelperBinaryPath(): string {
	return path.join(app.getPath("userData"), "native-tools", "morec-system-cursors");
}
...
export function getNativeCursorMonitorBinaryPath(): string {
	return path.join(app.getPath("userData"), "native-tools", "morec-native-cursor-monitor");
}
...
export function getNativeWindowListBinaryPath(): string {
	return path.join(app.getPath("userData"), "native-tools", "morec-window-list");
}
