...
const TRUSTED_DOCUMENT_BASE_URLS = [
	...
	"file:///C:/Program%20Files/MoRec/resources/app.asar/dist/index.html",
];
...
describe("isTrustedCaptureDocumentUrl", () => {
	...
	])("accepts a MoRec HUD document: %s", (candidateUrl) => {
	...
	it.each([
		...
		"file:///C:/Program%20Files/MoRec/resources/app.asar/dist/other.html?windowType=hud-overlay",
		"file:///C:/Program%20Files/MoRec/resources/app.asar/dist/index.html/child?windowType=hud-overlay",
		"data:text/html,morec?windowType=hud-overlay",
		"not a url",
	])("rejects a non-MoRec capture document: %s", (candidateUrl) => {
...
describe("shouldGrantDisplayCapture", () => {
	...
	it.each([
		["another BrowserWindow", { isTrustedCaptureWindow: false }],
		["a subframe", { isMainFrame: false }],
		["a non-MoRec document", { currentDocumentUrl: "https://example.com/" }],
