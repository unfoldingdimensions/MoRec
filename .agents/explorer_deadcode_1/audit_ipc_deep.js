...
const devTypesPath = path.join(rootDir, 'electron', 'electron-env.d.ts');
//also check vite-env.d.ts
const viteEnvPath = path.join(rootDir, 'src', 'vite-env.d.ts');
