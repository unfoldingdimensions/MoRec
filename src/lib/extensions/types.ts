/**
 * Mo Rec Extension System — Core Types
 *
...
// ---------------------------------------------------------------------------
// Extension Manifest (morec-extension.json)
// ---------------------------------------------------------------------------
...
export interface ExtensionManifest {
	...
	license?: string;
	/** Minimum Mo Rec version required */
	engine?: string;
 ...
 *
 * Mo Rec does not auto-register these entries at runtime today.
...
export interface MoRecExtensionAPI {
...
export interface MoRecExtensionModule {
	/** Called when the extension is activated */
	activate(api: MoRecExtensionAPI): void | Promise<void>;
...
export type RecordlyExtensionAPI = MoRecExtensionAPI;
export type RecordlyExtensionModule = MoRecExtensionModule;
