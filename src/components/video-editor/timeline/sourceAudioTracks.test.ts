...
describe("timeline source audio tracks", () => {
	it("builds candidates for Windows and macOS sidecar containers", () => {
		expect(buildSourceSidecarPathCandidates("C:\\MoRec\\recording-1.mp4", "mic")).toEqual([
			"C:/MoRec/recording-1.mic.wav",
			"C:/MoRec/recording-1.mic.m4a",
			"C:/MoRec/recording-1.mic.webm",
		]);
	});
