...
export const EDITOR_PREFERENCES_STORAGE_KEY = "morec.editor.preferences";
export const EDITOR_PRESETS_STORAGE_KEY = "morec.editor.presets";
...
export const DEFAULT_EDITOR_PREFERENCES: EditorPreferences = {
	...
	exportCanvas: DEFAULT_EDITOR_CONTROLS.exportCanvas,
...
function normalizeEditorControls(
	...
	const candidate: PartialEditorControls = {
		...
		exportCanvas: sanitizedRaw.exportCanvas ?? fallback.exportCanvas,
		mp4FrameRate:
	...
	return {
		...
		exportCanvas: normalized.exportCanvas,
