...
export type ZoomTransitionEasing = "morec" | "recordly" | "glide" | "smooth" | "snappy" | "linear";
...
export const DEFAULT_ZOOM_IN_EASING: ZoomTransitionEasing = "morec";
export const DEFAULT_ZOOM_OUT_EASING: ZoomTransitionEasing = "morec";
